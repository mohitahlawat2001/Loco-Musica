...
const Body = () => {
  ...
  return (
    <>
      <div className="p-4 lg:mx-10 text-center rounded-xl justify-items-center ">
        {/* <input
...
/> */}
        ...
        {error && (
          <p className="py-2 font-bold text-center text-red-500">{error}</p>
        )}
        {allRestaurants?.length === 0 ? (
          ...
          <div
            ...
            className="flex flex-row flex-wrap justify-center 2xl:mx-20"
          >
